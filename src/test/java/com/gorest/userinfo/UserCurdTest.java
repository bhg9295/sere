...
public class UserCurdTest extends  TestBase {
    ...
    static String name = "Krisha" + TestUtils.getRandomValue();
    static String email = "Krisha93@gmail.com" + TestUtils.getRandomValue();
    static  String gender = "fmale"+ TestUtils.getRandomValue();
    static String status = "inactive"+ TestUtils.getRandomValue();
    ...
    {
        String email = TestUtils.getRandomValue() + "roman99@gmail.com";
        UserPojo userpojo = new UserPojo();
        userpojo.setName("Krish");
        ...
        public void verifyUserUpdatedSuccessfully() {
            ...
            String email = TestUtils.getRandomValue() + "roman@gmail.com";
            UserPojo userpojo = new UserPojo();
            userpojo.setName("Krish");
            userpojo.setEmail(email);
            userpojo.setGender("male");
